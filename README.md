...
```
npm create cloudflare@latest -- --template=cloudflare/templates/withered-bush-a6c7
```

A live public deployment of this template is available at [https://withered-bush-a6c7.templates.workers.dev](https://withered-bush-a6c7.templates.workers.dev)
